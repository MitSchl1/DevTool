...
namespace DevTool
{
    internal class Acosh : IAdvancedCalculation
    {
        private double result;
        public double CalcWithOnePassedValue(double numberOne)
        {
            result = Math.Acosh(numberOne);
            return result;
        }
        ...
        public void Definition()
        {
            ...
            Console.WriteLine("Acosh gibt einen Winkel zurück, dessen hyperbolischen Kosinus die angegebene Zahl ist.");

...
namespace DevTool
{
    internal class Asinh : IAdvancedCalculation
    {
        private double result;
        public double CalcWithOnePassedValue(double numberOne)
        {
            result = Math.Asinh(numberOne);
            return result;
        }
        ...
        public void Definition()
        {
            ...
            Console.WriteLine("Asinh gibt einen Winkel zurück, dessen hyperbolischen Sinus die angegebene Zahl ist.");

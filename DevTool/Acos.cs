...
namespace DevTool
{
    internal class Acos : IAdvancedCalculation
    {
        private double result;
        public double CalcWithOnePassedValue(double numberOne)
        {
            result = Math.Acos(numberOne);
            return result;
        }
        ...
        public void Definition()
        {
            ...
            Console.WriteLine("Acos gibt einen Winkel zurück, dessen Kosinus die angegebene Zahl ist.");

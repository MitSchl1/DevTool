...
namespace DevTool
{
    internal class Atan : IAdvancedCalculation
    {
        private double result;
        public double CalcWithOnePassedValue(double numberOne)
        {
            result = Math.Atan(numberOne);
            return result;
        }
        ...
        public void Definition()
        {
            ...
            Console.WriteLine("Atan gibt einen Winkel zurück, dessen Tangens die angegebene Zahl ist.");

...
namespace DevTool
{
    internal class Atanh : IAdvancedCalculation
    {
        private double result;
        public double CalcWithOnePassedValue(double numberOne)
        {
            result = Math.Atanh(numberOne);
            return result;
        }
        ...
        public void Definition()
        {
            ...
            Console.WriteLine("Atanh gibt einen Winkel zurück, dessen hyperbolischen Tangens die angegebene Zahl ist.");
